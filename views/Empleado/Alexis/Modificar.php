...
$empleado->setIdUsuario($_GET['idu']);
$empleado->Modificar();
?>
<div class="container">
  ...
  <form class="form-horizontal" action="../../controllers/Empleado.php?action=Modificar" method="post" onsubmit="return confirm('¿Seguro que quieres guardar este formulario?');">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="number" class="form-control" id="apellidoP"  name="apellidoP" value="<?php echo $empleado->getApellidoP(); ?>" required>
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="idu">Numero Usuario:</label>
      <div class="col-sm-10">
    ...
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-primary" name="ModificarGuardar">Guardar</button>
